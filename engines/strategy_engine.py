...
def compute_signals(df: pd.DataFrame, fast_len: int = 5, slow_len: int = 20, stop_len: int = 30):
    df = df.copy()
...
def trade_loop(df, starting_capital: float = 10000.0, position_size: float = 1.0):
